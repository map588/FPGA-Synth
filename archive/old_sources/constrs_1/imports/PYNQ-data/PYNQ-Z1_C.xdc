...
# Define the area for the pblock (approximately 12% of FPGA resources)

# Add the reconfigurable module to this pblock

# Set the reconfigurable property on the module

# Allow the tools to automatically place the pblock

# Optionally, you can provide some guidance on resource allocation
# Uncomment and adjust these if you want to limit resource usage
# set_property PERCENT_AREA 5 [get_pblocks pblock_reconfig]
# set_property MAX_UTILIZATION 50 [get_pblocks pblock_reconfig]

# Enable snapping mode for the pblock

# set_property HD.RECONFIGURABLE true [get_cells zynq_system_i/hier_0]
# set_property HD.PLATFORM_WRAPPER true [get_cells	zynq_system_i/hier_0]

# create_pblock MIDI_PBLOCK
# resize_pblock [get_pblocks MIDI_PBLOCK] -add {SLICE_X44Y73:SLICE_X81Y114}
# resize_pblock [get_pblocks MIDI_PBLOCK] -add {RAMB18_X3Y30:RAMB18_X3Y45}
# resize_pblock [get_pblocks MIDI_PBLOCK] -add {RAMB36_X3Y15:RAMB36_X3Y22}

# add_cells_to_pblock [get_pblocks MIDI_PBLOCK] [get_cells zynq_system_i/hier_0]
# set_property SNAPPING_MODE ON [get_pblocks MIDI_PBLOCK]
