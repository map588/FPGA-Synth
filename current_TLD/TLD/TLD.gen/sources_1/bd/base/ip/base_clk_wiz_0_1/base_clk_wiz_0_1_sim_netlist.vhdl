...
-- Command     : write_vhdl -force -mode funcsim -rename_top base_clk_wiz_0_1 -prefix
--               base_clk_wiz_0_1_ base_clk_wiz_0_1_sim_netlist.vhdl
...
architecture STRUCTURE of base_clk_wiz_0_1_base_clk_wiz_0_1_clk_wiz is
  ...
  signal clk_out1_base_clk_wiz_0_1_en_clk : STD_LOGIC;
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out1_base_clk_wiz_0_1_en_clk
    );
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_base_clk_wiz_0_1_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg1(0)
