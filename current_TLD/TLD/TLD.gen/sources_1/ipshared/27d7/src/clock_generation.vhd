...
begin
    ...
    process (clk_100MHz, async_resetn) is
    begin
        if async_resetn = '0' then
            clk_100_meta <= '0';
            clk_100_int <= '0';
            clk_100_sync <= '0';
        elsif rising_edge(clk_100MHz) then -- Triple-stage clock synchronization
            clk_100_meta <=clk_100MHz;
            clk_100_sync <= clk_100_meta;
            clk_100_int <= clk_100_sync;
        end if;
    end process;
