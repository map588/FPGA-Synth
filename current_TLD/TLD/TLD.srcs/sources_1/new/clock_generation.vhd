...
entity Clock_Manager is
  port (
    ...
    clock_locked      : in  STD_LOGIC; -- Clock locked signal
...
begin
  ...
  begin
    if rising_edge(clk_24_576MHz) then
      ...
      reset_sync_ff(1) <= reset_sync_ff(0) and clock_locked;
    end if;
  end process;

  sync_reset  <= not reset_sync_ff(1);
  internal_reset <= reset_sync_ff(1);
