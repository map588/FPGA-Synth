...
--               c:/Users/Matt/Documents/Vivado_Projects/git_clone/FPGA_Synth/experiment_i2s_output/experiment_i2s_output.srcs/sources_1/bd/clocked_i2s/ip/clocked_i2s_util_ds_buf_0_0/clocked_i2s_util_ds_buf_0_0_sim_netlist.vhdl
...
entity clocked_i2s_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is "BUFG";
  attribute C_MODE : string;
  attribute C_MODE of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of clocked_i2s_util_ds_buf_0_0_util_ds_buf : entity is "util_ds_buf";
end clocked_i2s_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of clocked_i2s_util_ds_buf_0_0_util_ds_buf is
...
entity clocked_i2s_util_ds_buf_0_0 is
  ...
  attribute NotValidForBitStream of clocked_i2s_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of clocked_i2s_util_ds_buf_0_0 : entity is "clocked_i2s_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of clocked_i2s_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of clocked_i2s_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2021.1";
end clocked_i2s_util_ds_buf_0_0;

architecture STRUCTURE of clocked_i2s_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of BUFG_I : signal is "XIL_INTERFACENAME BUFG_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_1_clk_out1, INSERT_VIP 0";
  attribute x_interface_info of BUFG_O : signal is "xilinx.com:signal:clock:1.0 BUFG_O CLK";
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN clocked_i2s_util_ds_buf_0_0_BUFG_O, INSERT_VIP 0";
begin
U0: entity work.clocked_i2s_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
