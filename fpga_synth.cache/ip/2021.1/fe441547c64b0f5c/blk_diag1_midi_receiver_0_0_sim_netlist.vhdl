...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_midi_receiver is
  ...
  signal \packet_10_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \packet_10_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \packet_10_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \packet_10_carry__0_i_4_n_0\ : STD_LOGIC;
  ...
  signal \packet_10_carry__1_i_1_n_0\ : STD_LOGIC;
  signal \packet_10_carry__1_i_2_n_0\ : STD_LOGIC;
  signal \packet_10_carry__1_i_3_n_0\ : STD_LOGIC;
  signal \packet_10_carry__1_i_4_n_0\ : STD_LOGIC;
  ...
  signal \packet_10_carry__2_i_1_n_0\ : STD_LOGIC;
  signal \packet_10_carry__2_i_2_n_0\ : STD_LOGIC;
  signal \packet_10_carry__2_i_3_n_0\ : STD_LOGIC;
  ...
  signal \status_data[7]_i_1_n_0\ : STD_LOGIC;
...
\packet_10_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \packet_10_carry__0_i_1_n_0\,
      S(2) => \packet_10_carry__0_i_2_n_0\,
      S(1) => \packet_10_carry__0_i_3_n_0\,
      S(0) => \packet_10_carry__0_i_4_n_0\
    );
\packet_10_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \packet_10_carry__1_i_1_n_0\,
      S(2) => \packet_10_carry__1_i_2_n_0\,
      S(1) => \packet_10_carry__1_i_3_n_0\,
      S(0) => \packet_10_carry__1_i_4_n_0\
    );
\packet_10_carry__1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__1_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__1_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__1_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => \packet_10_carry__2_i_1_n_0\,
      S(1) => \packet_10_carry__2_i_2_n_0\,
      S(0) => \packet_10_carry__2_i_3_n_0\
    );
\packet_10_carry__2_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__2_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\packet_10_carry__2_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\status_data[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
