...
#
# Generated by export_simulation on Thu Sep 12 04:33:07 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './blk_diag1.sh' script.

./blk_diag1.sh -reset_run
...
./blk_diag1.sh -noclean_files

For more information on the script, please type './blk_diag1.sh -help'.
