...
HD_PWD='C:/Users/Matt/Documents/Vivado_Projects/fpga_synth/fpga_synth.runs/high_perf'
cd "$HD_PWD"
...
EAStep vivado -log blk_diag1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_diag1_wrapper.tcl
