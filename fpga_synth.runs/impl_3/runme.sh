...
HD_PWD='C:/Users/Matt/Documents/Vivado_Projects/fpga_synth/fpga_synth.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log blk_diag1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blk_diag1_wrapper.tcl -notrace
