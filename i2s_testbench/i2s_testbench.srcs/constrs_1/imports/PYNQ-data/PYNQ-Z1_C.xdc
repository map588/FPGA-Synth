...
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports mclk_out]
...
create_pblock pblock_i2s_tx_bfrd_rl_0
add_cells_to_pblock [get_pblocks pblock_i2s_tx_bfrd_rl_0] [get_cells -quiet [list base_i/i2s_tx_buffered_real_0]]
resize_pblock [get_pblocks pblock_i2s_tx_bfrd_rl_0] -add {SLICE_X12Y4:SLICE_X13Y26}
create_pblock pblock_clocks_n_sets
add_cells_to_pblock [get_pblocks pblock_clocks_n_sets] [get_cells -quiet [list base_i/clocks_n_sets]]
resize_pblock [get_pblocks pblock_clocks_n_sets] -add {SLICE_X6Y7:SLICE_X7Y21}
create_pblock pblock_midi_decoder_0
add_cells_to_pblock [get_pblocks pblock_midi_decoder_0] [get_cells -quiet [list base_i/midi_decoder_0]]
resize_pblock [get_pblocks pblock_midi_decoder_0] -add {SLICE_X42Y90:SLICE_X43Y108}
create_pblock pblock_ps7_0
add_cells_to_pblock [get_pblocks pblock_ps7_0] [get_cells -quiet [list base_i/ps7_0]]
resize_pblock [get_pblocks pblock_ps7_0] -add {SLICE_X8Y19:SLICE_X9Y19}
create_pblock pblock_midi_interface_0
add_cells_to_pblock [get_pblocks pblock_midi_interface_0] [get_cells -quiet [list base_i/midi_interface_0]]
resize_pblock [get_pblocks pblock_midi_interface_0] -add {SLICE_X10Y11:SLICE_X11Y18}
create_pblock pblock_oscilator_stub_0
add_cells_to_pblock [get_pblocks pblock_oscilator_stub_0] [get_cells -quiet [list base_i/oscilator_stub_0]]
resize_pblock [get_pblocks pblock_oscilator_stub_0] -add {SLICE_X8Y13:SLICE_X9Y16}
create_pblock pblock_selectio_wiz_0
add_cells_to_pblock [get_pblocks pblock_selectio_wiz_0] [get_cells -quiet [list base_i/selectio_wiz_0]]
resize_pblock [get_pblocks pblock_selectio_wiz_0] -add {SLICE_X8Y17:SLICE_X9Y18}
create_pblock pblock_proc_sys_reset_2
add_cells_to_pblock [get_pblocks pblock_proc_sys_reset_2] [get_cells -quiet [list base_i/clocks_n_sets/proc_sys_reset_2]]
set_property PARENT pblock_clocks_n_sets [get_pblocks pblock_proc_sys_reset_2]
create_pblock pblock_proc_sys_reset_1
add_cells_to_pblock [get_pblocks pblock_proc_sys_reset_1] [get_cells -quiet [list base_i/clocks_n_sets/proc_sys_reset_1]]
set_property PARENT pblock_clocks_n_sets [get_pblocks pblock_proc_sys_reset_1]
create_pblock pblock_proc_sys_reset_3
add_cells_to_pblock [get_pblocks pblock_proc_sys_reset_3] [get_cells -quiet [list base_i/clocks_n_sets/proc_sys_reset_3]]
set_property PARENT pblock_clocks_n_sets [get_pblocks pblock_proc_sys_reset_3]
create_pblock pblock_i2s_module_0
add_cells_to_pblock [get_pblocks pblock_i2s_module_0] [get_cells -quiet [list base_i/i2s_tx_buffered_real_0/U0/i2s_module_0]]
set_property PARENT pblock_i2s_tx_bfrd_rl_0 [get_pblocks pblock_i2s_module_0]
create_pblock pblock_Clock_Manager_0
add_cells_to_pblock [get_pblocks pblock_Clock_Manager_0] [get_cells -quiet [list base_i/i2s_tx_buffered_real_0/U0/Clock_Manager_0]]
set_property PARENT pblock_i2s_tx_bfrd_rl_0 [get_pblocks pblock_Clock_Manager_0]
create_pblock pblock_clk_wiz_1
add_cells_to_pblock [get_pblocks pblock_clk_wiz_1] [get_cells -quiet [list base_i/i2s_tx_buffered_real_0/U0/clk_wiz_1]]
set_property PARENT pblock_i2s_tx_bfrd_rl_0 [get_pblocks pblock_clk_wiz_1]
create_pblock pblock_clk_wiz_0
add_cells_to_pblock [get_pblocks pblock_clk_wiz_0] [get_cells -quiet [list base_i/i2s_tx_buffered_real_0/U0/clk_wiz_0]]
set_property PARENT pblock_i2s_tx_bfrd_rl_0 [get_pblocks pblock_clk_wiz_0]
create_pblock pblock_fifo_reader_0
add_cells_to_pblock [get_pblocks pblock_fifo_reader_0] [get_cells -quiet [list base_i/midi_decoder_0/U0/fifo_reader_0]]
set_property PARENT pblock_midi_decoder_0 [get_pblocks pblock_fifo_reader_0]
create_pblock pblock_fifo_adapter_0
add_cells_to_pblock [get_pblocks pblock_fifo_adapter_0] [get_cells -quiet [list base_i/midi_decoder_0/U0/fifo_adapter_0]]
set_property PARENT pblock_midi_decoder_0 [get_pblocks pblock_fifo_adapter_0]
create_pblock pblock_param_file
add_cells_to_pblock [get_pblocks pblock_param_file] [get_cells -quiet [list base_i/midi_decoder_0/U0/param_file]]
set_property PARENT pblock_midi_decoder_0 [get_pblocks pblock_param_file]
