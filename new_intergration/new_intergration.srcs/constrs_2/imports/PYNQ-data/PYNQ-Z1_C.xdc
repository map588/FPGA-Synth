...
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { midi_in }]; #IO_L21P_T3_DQS_34 Sch=ck_io[8]
...
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports lrclk_out]
