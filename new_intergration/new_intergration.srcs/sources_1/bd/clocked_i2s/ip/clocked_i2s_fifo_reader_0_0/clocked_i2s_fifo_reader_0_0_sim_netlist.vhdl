...
-- Command     : write_vhdl -force -mode funcsim -rename_top clocked_i2s_fifo_reader_0_0 -prefix
--               clocked_i2s_fifo_reader_0_0_ clocked_i2s_fifo_reader_0_0_sim_netlist.vhdl
...
entity clocked_i2s_fifo_reader_0_0_fifo_reader is
  port (
...
end clocked_i2s_fifo_reader_0_0_fifo_reader;

architecture STRUCTURE of clocked_i2s_fifo_reader_0_0_fifo_reader is
  ...
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_reg[0]\ : label is "idle:001,pop:010,intake:100,";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_reg[1]\ : label is "idle:001,pop:010,intake:100,";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_reg[2]\ : label is "idle:001,pop:010,intake:100,";
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \data[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data[10]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data[11]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data[12]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \data[13]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \data[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data[9]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \process_data.trig_i_1\ : label is "soft_lutpair0";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity clocked_i2s_fifo_reader_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    not_empty : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of clocked_i2s_fifo_reader_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of clocked_i2s_fifo_reader_0_0 : entity is "clocked_i2s_fifo_reader_0_0,fifo_reader,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of clocked_i2s_fifo_reader_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of clocked_i2s_fifo_reader_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of clocked_i2s_fifo_reader_0_0 : entity is "fifo_reader,Vivado 2021.1";
end clocked_i2s_fifo_reader_0_0;

architecture STRUCTURE of clocked_i2s_fifo_reader_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_RESET rst, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN clocked_i2s_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  attribute x_interface_info of rst : signal is "xilinx.com:signal:reset:1.0 rst RST";
  attribute x_interface_parameter of rst : signal is "XIL_INTERFACENAME rst, POLARITY ACTIVE_LOW, INSERT_VIP 0";
begin
U0: entity work.clocked_i2s_fifo_reader_0_0_fifo_reader
     port map (
      clk => clk,
