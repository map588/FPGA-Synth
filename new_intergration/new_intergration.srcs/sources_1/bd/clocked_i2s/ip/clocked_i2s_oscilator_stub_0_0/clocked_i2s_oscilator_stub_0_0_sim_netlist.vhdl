...
-- Command     : write_vhdl -force -mode funcsim -rename_top clocked_i2s_oscilator_stub_0_0 -prefix
--               clocked_i2s_oscilator_stub_0_0_ clocked_i2s_oscilator_stub_0_0_sim_netlist.vhdl
...
entity clocked_i2s_oscilator_stub_0_0_oscilator_stub is
  port (
...
end clocked_i2s_oscilator_stub_0_0_oscilator_stub;

architecture STRUCTURE of clocked_i2s_oscilator_stub_0_0_oscilator_stub is
  signal current_note : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal current_note0 : STD_LOGIC;
  signal oscilator_out0 : STD_LOGIC;
  signal \oscilator_out[17]_i_2_n_0\ : STD_LOGIC;
begin
...
\oscilator_out[17]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\oscilator_out[17]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => rst_n,
      O => \oscilator_out[17]_i_2_n_0\
    );
...
entity clocked_i2s_oscilator_stub_0_0 is
  ...
  attribute NotValidForBitStream of clocked_i2s_oscilator_stub_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of clocked_i2s_oscilator_stub_0_0 : entity is "clocked_i2s_oscilator_stub_0_0,oscilator_stub,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of clocked_i2s_oscilator_stub_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of clocked_i2s_oscilator_stub_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of clocked_i2s_oscilator_stub_0_0 : entity is "oscilator_stub,Vivado 2021.1";
end clocked_i2s_oscilator_stub_0_0;

architecture STRUCTURE of clocked_i2s_oscilator_stub_0_0 is
...
U0: entity work.clocked_i2s_oscilator_stub_0_0_oscilator_stub
     port map (
