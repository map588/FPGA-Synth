...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NUM_VOICES" -parent ${Page_0}
...
proc update_MODELPARAM_VALUE.NUM_VOICES { MODELPARAM_VALUE.NUM_VOICES PARAM_VALUE.NUM_VOICES } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUM_VOICES}] ${MODELPARAM_VALUE.NUM_VOICES}
}
