...
entity clocked_i2s is
  ...
  attribute CORE_GENERATION_INFO of clocked_i2s : entity is "clocked_i2s,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=clocked_i2s,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_board_cnt=4,da_clkrst_cnt=3,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of clocked_i2s is
  ...
  signal stream_controller_0_drop_count : STD_LOGIC_VECTOR ( 31 downto 0 );
...
begin
  ...
  drop_count(31 downto 0) <= stream_controller_0_drop_count(31 downto 0);
